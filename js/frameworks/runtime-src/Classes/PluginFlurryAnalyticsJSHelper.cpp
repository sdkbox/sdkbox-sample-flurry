...
#if defined(MOZJS_MAJOR_VERSION)
#if MOZJS_MAJOR_VERSION >= 33
void register_all_PluginFlurryAnalyticsJS_helper(JSContext* cx, JS::HandleObject global) {
...
#else
void register_all_PluginFlurryAnalyticsJS_helper(JSContext* cx, JSObject* global) {
    JS::RootedObject pluginObj(cx);
    sdkbox::getJsObjOrCreat(cx, JS::RootedObject(cx, global), "sdkbox.PluginFlurryAnalytics", &pluginObj);
